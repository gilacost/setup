...
export ZSH=/Users/tboe/.oh-my-zsh
...
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/tboe/.npm-packages/bin"
...
alias remlb='git branch | grep -v "master" | xargs git branch -D'
